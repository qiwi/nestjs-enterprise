  ...
  if (this._handler.ping.length === 0) {
    ...
    this._handler.ping(function (err, result) {
      ...
      if (err === null || typeof err === 'undefined') {
        result_obj = new Calculator_ping_result(
...
CalculatorProcessor.prototype.process_add = function (seqid, input, output) {
  ...
  if (this._handler.add.length === 2) {
    ...
    this._handler.add(args.num1, args.num2, function (err, result) {
      var result_obj
      if (err === null || typeof err === 'undefined') {
        result_obj = new Calculator_add_result(
          err !== null || typeof err === 'undefined'
            ? err
            : { success: result },
        )
...
CalculatorProcessor.prototype.process_calculate = function (
  seqid,
  input,
  output,
) {
  ...
  if (this._handler.calculate.length === 2) {
    Q.fcall(this._handler.calculate.bind(this._handler), args.logid, args.w)
      .then(function (result) {
    ...
    this._handler.calculate(args.logid, args.w, function (err, result) {
      ...
      if (
        ...
        err instanceof ttypes.InvalidOperation
      ) {
        result_obj = new Calculator_calculate_result(
          err !== null || typeof err === 'undefined'
            ? err
            : { success: result },
        )
